...
# Widget pour ouvrir la liste dans une application de notes
def render_share_widget(text: str, height: int = 90) -> None:
    """
    Affiche deux boutons :
    - Copier : copie le texte dans le presse-papiers.
    - Partager : ouvre le sélecteur de partage natif quand disponible.
    """
          ...
          copyBtn.addEventListener("click", async () => {{
            try {{
              ...
              try {{
                ...
                status.textContent =
                  "Copie auto impossible, sélectionne le texte à la main.";
              }}
